...
public class Imp1Parser implements Imp1ParserConstants {
  ...
  static final public Write PWriteD() throws ParseException {
        ValorDataL val;
    jj_consume_token(WRITE);
    jj_consume_token(LPAREN);
    val = PExpressao();
  ...
  static final public Valor PValorDataL() throws ParseException {
        Token token;
    token = jj_consume_token(STRINGL_LITERAL);
                String tokenStr = token.toString();
                {if (true) return new ValorStringL(tokenStr);}
...
/*  ADICIONADO OU MODIFICADO DA Imperativa1 PARA A Imperativa2  */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x3b0000,0x180000,0x6000,0x6000,0x6000,0x1800,0x6000,0x3b0000,0x8000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x1440,0x0,0x0,0x231,0x671,0x0,0x671,0x1440,0x400,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x8,0x0,0x0,0x0,};
   }
